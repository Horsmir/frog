...
void frog::on_actionAbout_triggered()
{
	...
	str1 = trUtf8("<h2>%1 0.2.1</h2><p><b>%1</b> - пасьянс с двумя колодами также называют «Жаба в норе». Имеются восемь баз, основанных на тузах, и пять стопок сброса.</p><p>Copyright &copy;  2012 Роман Браун</p>").arg(appName);
